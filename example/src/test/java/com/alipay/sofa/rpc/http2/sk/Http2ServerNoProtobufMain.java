 ...
 */
public class Http2ServerNoProtobufMain {
    /**
     * slf4j Logger for this class
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(Http2ServerNoProtobufMain.class);
    ...
    public static void main(String[] args) {
        ...
        // ==> 原来得访问“http://127.0.0.1:12300/com.alipay.sofa.rpc.test.HelloService/sayHello?name=Bob&age=2”才行
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    LOGGER.info("【B】queue: {}", executor.getQueue().size());
                    try {
                        Thread.sleep(1000);
